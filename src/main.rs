...
fn read_file_chunk(file: &mut File, overlap: Vec<u8>) -> (Vec<u8>, usize, bool) {
    let offset: usize = 0;
...
fn handle_overlap(buffer: Vec<u8>, file: &mut File, bytes_read: usize) -> (usize, Vec<u8>) {
